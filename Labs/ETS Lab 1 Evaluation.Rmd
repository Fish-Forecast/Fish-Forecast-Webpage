...
spp <- "Anchovy"
landings <- subset(greeklandings, Species==spp)
traindat <- ts(subset(landings, Year <= 1987)$log.metric.tons, start=1964)
testdat <- ts(subset(landings, Year == 1988 | Year==1989)$log.metric.tons, start=1988)
n.fr <- length(testdat)
```
